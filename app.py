...
def visualize_detections(image, detections):
    for box in detections[0]['boxes']:
        ...
        cv2.rectangle(image, (x1, y1), (x2, y2), (0, 255, 0), 2)  #Define a function to visualize the detection results
...
def predict():
    ...
    detections = detect_objects(image_tensor, model) #Call the visualize_detections function after performing object detection
    visualize_detections(resized_image, detections)

    output_image_path = 'static/output.jpg' #Save the output image with the detection results
